...
class _HomePageState extends State<HomePage> {
      ...
      MaterialPageRoute(
        builder: (context) => EscaneoPage(
          onCodigoEscaneado: (codigo) {
            ...
            _registrarRetiroAutomatico(codigo);
          },
        ),
      ),
    );
  ...
  Future<void> _registrarRetiroAutomatico(String codigo) async {
  ...
  Future<void> _registrarRetiro() async {
    await _registrarRetiroAutomatico(_carnetCtrl.text.trim());
  }
...
class _EscaneoPageState extends State<EscaneoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF1A237E), // Azul oscuro idéntico a tu referencia
        foregroundColor: Colors.white,
        centerTitle: true,
      ),
      body: Stack(
        children: [
          // Vista de la cámara de fondo
          MobileScanner(onDetect: _onDetect),
          
          // Marco central con las esquinas azules de enfoque
          Center(
            child: Container(
              width: 300,
              height: 200,
  ...
  // Widget auxiliar para dibujar cada esquina del recuadro
